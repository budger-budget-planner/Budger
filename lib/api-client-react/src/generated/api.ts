 ...
 */
export const getGetWalletTokenUrl = () => {
  return `/api/wallet/token`;
};

export const getWalletToken = async (
  options?: RequestInit,
): Promise<WalletToken> => {
  return customFetch<WalletToken>(getGetWalletTokenUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetWalletTokenQueryKey = () => {
  return [`/api/wallet/token`] as const;
};

export const getGetWalletTokenQueryOptions = <
  TData = Awaited<ReturnType<typeof getWalletToken>>,
  TError = ErrorType<void>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getWalletToken>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetWalletTokenQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getWalletToken>>> = ({
    signal,
  }) => getWalletToken({ signal, ...requestOptions });
...
export type GetWalletTokenQueryResult = NonNullable<
  Awaited<ReturnType<typeof getWalletToken>>
>;
export type GetWalletTokenQueryError = ErrorType<void>;

/**
 * @summary Get or generate the user's iOS Shortcut webhook token
 */

export function useGetWalletToken<
  TData = Awaited<ReturnType<typeof getWalletToken>>,
  TError = ErrorType<void>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetWalletTokenQueryOptions(options);
 ...
 */
export const getRegenerateWalletTokenUrl = () => {
  return `/api/wallet/token`;
};

export const regenerateWalletToken = async (
  options?: RequestInit,
): Promise<WalletToken> => {
  return customFetch<WalletToken>(getRegenerateWalletTokenUrl(), {
    ...options,
    method: "POST",
  });
};

export const getRegenerateWalletTokenMutationOptions = <
  TError = ErrorType<void>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof regenerateWalletToken>>,
    TError,
    void,
    TContext
  >;
  ...
  TContext
> => {
  const mutationKey = ["regenerateWalletToken"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  const mutationFn: MutationFunction<
    ...
    void
  > = () => {
    return regenerateWalletToken(requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type RegenerateWalletTokenMutationResult = NonNullable<
  Awaited<ReturnType<typeof regenerateWalletToken>>
>;

export type RegenerateWalletTokenMutationError = ErrorType<void>;

/**
 * @summary Regenerate the user's iOS Shortcut webhook token
 */
export const useRegenerateWalletToken = <
  TError = ErrorType<void>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getRegenerateWalletTokenMutationOptions(options));
};

/**
 * @summary Receive an Apple Wallet notification text and create a transaction
 */
export const getIngestWalletNotificationUrl = () => {
  return `/api/wallet/ingest`;
};

export const ingestWalletNotification = async (
  walletIngestion: WalletIngestion,
  options?: RequestInit,
): Promise<Transaction> => {
  return customFetch<Transaction>(getIngestWalletNotificationUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(walletIngestion),
  });
};

export const getIngestWalletNotificationMutationOptions = <
  TError = ErrorType<void>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof ingestWalletNotification>>,
    TError,
    { data: BodyType<WalletIngestion> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["ingestWalletNotification"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return ingestWalletNotification(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type IngestWalletNotificationMutationResult = NonNullable<
  Awaited<ReturnType<typeof ingestWalletNotification>>
>;
export type IngestWalletNotificationMutationBody = BodyType<WalletIngestion>;
export type IngestWalletNotificationMutationError = ErrorType<void>;

/**
 * @summary Receive an Apple Wallet notification text and create a transaction
 */
export const useIngestWalletNotification = <
  TError = ErrorType<void>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getIngestWalletNotificationMutationOptions(options));
};
