...
import { db, larderEntriesTable, goalsTable, goalContributionsTable, transactionsTable, usersTable, greatLarderEntriesTable } from "../db";
...
// into a named savings bucket. The original deposit remains untouched.
