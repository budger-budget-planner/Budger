...
export const breakdownTransaction = async (
  id: number,
  breakdownInput: BreakdownTransactionInput,
  options?: RequestInit,
): Promise<BreakdownTransactionResponse> => {
  return customFetch<BreakdownTransactionResponse>(getBreakdownTransactionUrl(id), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
