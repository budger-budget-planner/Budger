...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "breakdown.title":          { en: "Break down transaction",              pl: "Podziel transakcję"              },
  "breakdown.original":       { en: "{desc} · {date} · {amount}",          pl: "{desc} · {date} · {amount}"      },
  "breakdown.receipt_discarded": { en: "The original receipt will be removed with this transaction.", pl: "Oryginalny paragon zostanie usunięty wraz z tą transakcją." },
  "breakdown.name":           { en: "Name",                                pl: "Nazwa"                            },
  "breakdown.name_placeholder": { en: "Groceries, supplies…",              pl: "Zakupy, środki czystości…"        },
  ...
  "breakdown.submit":          { en: "Break down",                         pl: "Podziel"                           },
  "breakdown.submitting":      { en: "Breaking down…",                     pl: "Dzielenie…"                       },
  "breakdown.success":         { en: "Transaction broken down successfully.", pl: "Transakcja została podzielona."  },
  "breakdown.failed":          { en: "Couldn't break down this transaction. Your original is unchanged.", pl: "Nie udało się podzielić transakcji. Oryginalna pozostała bez zmian." },
  ...
  "breakdown.category_unavailable": { en: "One of the selected categories is no longer available.", pl: "Jedna z wybranych kategorii nie jest już dostępna." },
  ...
  "breakdown.hold_hint":       { en: "Press and hold to break down",  pl: "Przytrzymaj, aby podzielić"       },
