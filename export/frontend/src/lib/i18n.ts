...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "profile.curr_switch_used_1":   { en: "Switch 1 of 2 used — one more change before a 15-min cooldown.",   pl: "Zmiana 1 z 2 — jeszcze jedna zmiana przed blokadą na 15 min."           },
  "profile.curr_switch_used_2":   { en: "Last allowed switch used — next change locks currency for 15 min.", pl: "Ostatnia dozwolona zmiana — kolejna zablokuje walutę na 15 min."         },
  "profile.curr_switch_locked":   { en: "Currency locked · unlocks in {countdown}",                         pl: "Waluta zablokowana · odblokowanie za {countdown}"                        },
  ...
  "breakdown.open":             { en: "Break down transaction",                         pl: "Rozbij transakcję"                                      },
  "breakdown.title":            { en: "Break down transaction",                         pl: "Rozbij transakcję"                                      },
  "breakdown.original":         { en: "{desc} · {date} · {amount}",                    pl: "{desc} · {date} · {amount}"                             },
  "breakdown.receipt_discarded": { en: "Receipt photos will not be copied to the replacement transactions.", pl: "Zdjęcia paragonów nie zostaną skopiowane do nowych transakcji." },
  "breakdown.name":             { en: "Description",                                    pl: "Opis"                                                   },
  "breakdown.name_placeholder": { en: "What was this part for?",                       pl: "Czego dotyczyła ta część?"                               },
  "breakdown.category":          { en: "Category",                                      pl: "Kategoria"                                              },
  "breakdown.add_row":           { en: "Add another row",                               pl: "Dodaj kolejny wiersz"                                   },
  "breakdown.remove":            { en: "Remove",                                        pl: "Usuń"                                                   },
  "breakdown.remove_row":        { en: "Remove allocation row",                        pl: "Usuń wiersz podziału"                                   },
  "breakdown.allocated":         { en: "Allocated",                                     pl: "Przydzielono"                                           },
  "breakdown.max_amount":        { en: "Up to {amount}",                               pl: "Maksymalnie {amount}"                                   },
  "breakdown.over":              { en: "Over by {amount}",                             pl: "Przekroczono o {amount}"                                },
  "breakdown.remaining":         { en: "{amount} remaining",                           pl: "Pozostało {amount}"                                     },
  "breakdown.name_required":      { en: "Enter a description.",                        pl: "Wpisz opis."                                            },
  ...
  "breakdown.submit":             { en: "Break down",                                   pl: "Rozbij"                                                 },
  ...
  "breakdown.failed":             { en: "Couldn't break down this transaction. Your original is unchanged.", pl: "Nie udało się rozbić tej transakcji. Oryginalna pozostała bez zmian." },
  "breakdown.source_missing":     { en: "This transaction is no longer available. Your list has been refreshed.", pl: "Ta transakcja nie jest już dostępna. Lista została odświeżona." },
  "breakdown.unavailable":        { en: "This transaction cannot be broken down because it belongs to another accounting flow.", pl: "Tej transakcji nie można podzielić, ponieważ należy do innego procesu księgowania." },
  ...
  // ── Categories ──
  "stretch.title":             { en: "Stretch budget",                      pl: "Rozciągnij budżet"                         },
  "stretch.for":               { en: "Stretching budget for",               pl: "Rozciągam budżet dla"                      },
  "stretch.source":            { en: "Source of extra budget",              pl: "Źródło dodatkowego budżetu"                },
  "stretch.source_locked":     { en: "Source",                              pl: "Źródło"                                    },
  "stretch.locked":            { en: "locked",                              pl: "zablokowane"                               },
  "stretch.month_label":       { en: "Budget month",                        pl: "Miesiąc budżetu"                           },
  "stretch.current_month":     { en: "Current month",                       pl: "Bieżący miesiąc"                           },
  "stretch.previous_month":    { en: "Previous month",                      pl: "Poprzedni miesiąc"                         },
  "stretch.next_month":        { en: "next month",                          pl: "następny miesiąc"                          },
  "stretch.current_budget":    { en: "current month",                       pl: "bieżący miesiąc"                           },
  "stretch.borrows_next":      { en: "Borrows from next month's budget",    pl: "Pożycza z budżetu następnego miesiąca"     },
  "stretch.borrows_current":   { en: "Borrows from current month's budget",  pl: "Pożycza z budżetu bieżącego miesiąca"       },
  "stretch.no_budget_warn":    { en: "Set a monthly budget on {name} first.", pl: "Najpierw ustaw miesięczny budżet dla {name}." },
  "stretch.max_note":          { en: "max",                                 pl: "maks."                                     },
  "stretch.amount_label":      { en: "Amount to stretch",                   pl: "Kwota rozciągnięcia"                       },
  "stretch.exceeds_max":       { en: "Exceeds max cross-month allowance",   pl: "Przekracza maks. limit między miesiącami"  },
  "stretch.zero_removes":      { en: "Setting to 0 will remove this stretch.", pl: "Ustawienie 0 usunie to rozciągnięcie."  },
  "stretch.stretch_btn":       { en: "Stretch",                             pl: "Rozciągnij"                                },
  "stretch.update_btn":        { en: "Update",                              pl: "Aktualizuj"                                },
  "stretch.adding":            { en: "Adding…",                             pl: "Dodawanie…"                                },
  "stretch.saving":            { en: "Saving…",                             pl: "Zapisywanie…"                              },
  "stretch.btn_label":         { en: "Stretch",                             pl: "Rozciągnij"                                },
  "stretch.stretched_label":   { en: "stretched",                           pl: "Rozciągnięto o"                            },
  "stretch.donated_label":     { en: "donated",                             pl: "Skurczono o"                               },
  "stretch.from_next_month":   { en: "from next month",                     pl: "z następnego miesiąca"                     },
  "stretch.from_last_month":   { en: "from last month",                     pl: "za ostatni miesiąc"                        },
  "stretch.network_error":     { en: "Network error — please try again",    pl: "Błąd sieci — spróbuj ponownie"             },
  ...
  "invite.declining":        { en: "Declining…",                   pl: "Odrzucanie…"                      },
  "invite.accepted":         { en: "Invitation accepted! 🎉",      pl: "Zaproszenie przyjęte! 🎉"          },
  "invite.accepted_msg":     { en: "You have joined {name}.",      pl: "Dołączyłeś(-aś) do {name}."      },
  "invite.declined":         { en: "Invitation declined.",         pl: "Zaproszenie odrzucone."            },
  "invite.declined_msg":     { en: "You have declined the invitation to join {name}.", pl: "Odrzucono zaproszenie do dołączenia do {name}." },
  "invite.invited_by":       { en: "Invited by {name}",            pl: "Zaproszono przez {name}"          },
  "invite.signup_to_join":   { en: "Create a free account to join the household.", pl: "Utwórz darmowe konto, aby dołączyć do gospodarstwa." },
  "invite.signup_btn":       { en: "Create account & join",        pl: "Utwórz konto i dołącz"            },
  ...
  "invite.server_error_title":    { en: "Something went wrong",       pl: "Coś poszło nie tak"               },
  ...
  "invite.first_name":       { en: "First name",                   pl: "Imię"                             },
  "invite.last_name":        { en: "Last name",                    pl: "Nazwisko"                         },
  "invite.create_account":   { en: "Create your account",          pl: "Utwórz konto"                     },
  "invite.set_pin":          { en: "Set your PIN",                 pl: "Ustaw swój PIN"                   },
  "invite.confirm_pin":      { en: "Confirm your PIN",             pl: "Potwierdź swój PIN"               },
  "invite.pins_dont_match":  { en: "PINs don't match. Please try again.", pl: "PIN-y się nie zgadzają. Spróbuj ponownie." },
  "invite.terms_note":       { en: "By creating an account, you agree to our Terms of Service and Privacy Policy.", pl: "Tworząc konto, akceptujesz Regulamin i Politykę Prywatności." },
  "invite.joined":           { en: "You've joined the household! 🎉", pl: "Dołączyłeś(-aś) do gospodarstwa! 🎉" },
  "invite.invalid_title":    { en: "Invalid invitation",           pl: "Nieprawidłowe zaproszenie"        },
  "invite.invalid_msg":      { en: "This invite link is no longer valid.", pl: "Ten link zaproszenia nie jest już ważny." },
  ...
  "hh.your_role_child_desc":    { en: "Can propose household goals. Can hide your personal dashboard from other members.",
                                   pl: "Może proponować cele. Może ukryć swój osobisty pulpit przed innymi członkami." },
  ...
  "hh.privacy_member_on":       { en: "Hidden from other members. Head of household can still see.",
                                   pl: "Ukryty przed innymi członkami. Głowa Rodziny nadal widzi."             },
  "hh.privacy_member_off":      { en: "Visible to other members. Head can always see yours.",
                                   pl: "Widoczny dla innych członków. Głowa Rodziny zawsze widzi Twój pulpit." },
  ...
  "tx.library":            { en: "Library",                                              pl: "Biblioteka"                                           },
  "tx.remove_all_receipts": { en: "Remove all receipts",                                pl: "Usuń wszystkie paragony"                              },
 ...
 "larder.hint_reset":       { en: "Press to hide and reset",         pl: "Przytrzymaj by wyzerować"           },
  ...
  "prefs.change_icon":            { en: "Change App Icon",                 pl: "Zmień ikonę aplikacji"               },
  "prefs.change_icon_desc":       { en: "Open in Safari and choose your Home Screen icon.", pl: "Otwórz w Safari i wybierz ikonę ekranu głównego." },
  "prefs.icon_picker_title":      { en: "Choose App Icon",                 pl: "Wybierz ikonę aplikacji"             },
  "prefs.icon_b_label":           { en: "Classic",                        pl: "Klasyczna"                            },
  "prefs.icon_badger_label":      { en: "Badger",                         pl: "Borsuk"                               },
  "prefs.icon_how_to":            { en: "To change icon open Budger.app in Safari → use Share → Add to Home Screen. If you already had an icon on your Home Screen, delete it and go through this process once more to refresh it.", pl: "Aby zmienić ikonę, otwórz Budger.app w Safari → wybierz Udostępnij → Dodaj do ekranu głównego. Jeśli masz już ikonę na ekranie głównym, usuń ją i powtórz ten proces, aby odświeżyć." },
  ...
  "larder.history_clear_confirm_desc":         { en: "All history entries will be hidden.",                 pl: "Wszystkie wpisy historii zostaną ukryte."                           },
  "larder.history_clear_also_transfers":       { en: "Also remove Great Larder transfer records",           pl: "Również usuń wpisy przekazań do Wielkiej Spiżarni"                  },
  "larder.history_clear_confirm_action":       { en: "Clear",                                              pl: "Wyczyść"                                                            },
