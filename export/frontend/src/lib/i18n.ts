...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "profile.curr_switch_used_2":   { en: "Last free switch used — next change locks currency for 15 min.",   pl: "Ostatnia bezpłatna zmiana — kolejna zablokuje walutę na 15 min."         },
