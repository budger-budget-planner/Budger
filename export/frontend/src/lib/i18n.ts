...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "profile.curr_switch_used_1":   { en: "Switch 1 of 2 used — one more change before a 5-min cooldown.",   pl: "Zmiana 1 z 2 — jeszcze jedna zmiana przed blokadą na 5 min."           },
  "profile.curr_switch_used_2":   { en: "Last allowed switch used — next change locks currency for 5 min.", pl: "Ostatnia dozwolona zmiana — kolejna zablokuje walutę na 5 min."         },
