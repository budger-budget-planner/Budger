...
import { useExtractScreenshotTransactions } from "@/lib/api-client";
        ...
        <DialogContent className="max-w-md max-h-[85vh] overflow-y-auto" onOpenAutoFocus={e => e.preventDefault()}>
          ...
          {isSniffing && (
            <div className="flex flex-col items-center gap-5 py-10">
              ...
              >
                {(nameInput || budgerName) ? t("tx.sniffing_named").replace("{name}", nameInput || budgerName!) : t("tx.sniffing_label")}
              </p>
