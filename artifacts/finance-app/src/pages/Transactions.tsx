...
import {
  ...
  useExtractScreenshotTransactions,
...
import { Plus, Pencil, Trash2, Search, Camera, X, ZoomIn, ImageOff, Image, Target, RefreshCw, Lock, Clock, ScanLine, Loader2, Check } from "lucide-react";
...
function ScreenshotImportDialog({
  open,
  onClose,
  categories,
  onImported,
