...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "ob.wallet_s5_desc":       { en: "Add a 'Get Contents of URL' action. Set Method to POST, paste your Budger webhook URL, and add two JSON body fields: 'token' (your key) and 'text' (the notification detail).",
                                pl: "Dodaj akcję 'Pobierz zawartość URL'. Ustaw metodę POST, wklej URL webhooka Budger i dodaj dwa pola JSON: 'token' (Twój klucz) oraz 'text' (szczegół powiadomienia)."},
