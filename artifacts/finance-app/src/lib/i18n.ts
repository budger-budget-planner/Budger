...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // Wallet step
  "ob.wallet_title":         { en: "Auto-import payments",            pl: "Automatyczny import płatności"     },
  "ob.wallet_subtitle":      { en: "Set up iOS Shortcuts to log Apple Pay purchases automatically",
                                pl: "Skonfiguruj Skróty iOS, aby automatycznie zapisywać płatności Apple Pay"},
  "ob.wallet_s1_title":      { en: "How it works",                    pl: "Jak to działa"                     },
  "ob.wallet_s1_desc":       { en: "After each Apple Pay payment, Wallet sends a notification (e.g. 'Spent £15.50 at Costa'). An iOS Shortcut catches that notification text and forwards it to Budger. No manual logging needed.",
                                pl: "Po każdej płatności Apple Pay Wallet wysyła powiadomienie (np. 'Zapłacono 15,50 zł w Costa'). Skrót iOS przechwytuje tekst tego powiadomienia i przesyła go do Budger. Bez ręcznego wpisywania."},
  "ob.wallet_s2_title":      { en: "New Automation → App",            pl: "Nowa Automatyzacja → Aplikacja"    },
  "ob.wallet_s2_desc":       { en: "Open Shortcuts → Automation tab → tap + (or 'New Automation'). In the trigger list choose 'App'. Do NOT pick 'Wallet' from the top list — that is the NFC card-tap trigger and it cannot read notification text.",
                                pl: "Otwórz Skróty → zakładka Automatyzacja → dotknij + (lub 'Nowa Automatyzacja'). Na liście wyzwalaczy wybierz 'Aplikacja'. NIE wybieraj 'Wallet' z górnej listy — to wyzwalacz NFC i nie może odczytać tekstu powiadomień."},
  "ob.wallet_s3_title":      { en: "Pick Wallet → Is Opened",         pl: "Wybierz Wallet → Jest otwierana"   },
  "ob.wallet_s3_desc":       { en: "Search for Wallet and select it. Pick 'Is Opened'. Continue to the next screen and turn 'Run Immediately' ON, 'Notify When Run' OFF. Save/Done. This fires the moment you tap the Wallet payment notification banner.",
                                pl: "Wyszukaj Wallet i wybierz. Wybierz 'Jest otwierana'. Przejdź dalej i ustaw 'Uruchom natychmiast' na WŁ, 'Powiadamiaj po uruchomieniu' na WYŁ. Zapisz. Odpala się w momencie dotknięcia baneru powiadomienia Wallet."},
  "ob.wallet_s4_title":      { en: "Tap the Search bar → type 'Get Details'", pl: "Dotknij paska wyszukiwania → wpisz 'Pobierz szczegóły'"},
  "ob.wallet_s4_desc":       { en: "You'll see a screen with app icons and a Search bar at the bottom. Do NOT pick from the apps list — Budger is a web app and won't appear there. Tap the Search bar, type 'Get Details of Notification', and add it. This reads the payment text from the Wallet notification.",
                                pl: "Zobaczysz ekran z ikonami aplikacji i paskiem wyszukiwania na dole. NIE wybieraj z listy aplikacji — Budger to aplikacja webowa i nie pojawi się tam. Dotknij paska wyszukiwania, wpisz 'Pobierz szczegóły powiadomienia' i dodaj. Odczytuje tekst płatności z powiadomienia Wallet."},
  "ob.wallet_s5_title":      { en: "Search bar again → 'Get Contents of URL'", pl: "Pasek wyszukiwania → 'Pobierz zawartość URL'"},
  "ob.wallet_s5_desc":       { en: "Tap Search again and type 'Get Contents of URL'. Add it. Set Method to POST, paste your Budger webhook URL. Tap 'Add new field' → JSON. Field 1: name 'token', value = your token (paste as text). Field 2: name 'text', value = tap the field then pick the 'Notification Detail' blue chip from step above.",
                                pl: "Dotknij Szukaj ponownie i wpisz 'Pobierz zawartość URL'. Dodaj. Ustaw metodę POST, wklej URL webhooka Budger. Dotknij 'Dodaj nowe pole' → JSON. Pole 1: nazwa 'token', wartość = Twój token (wklej jako tekst). Pole 2: nazwa 'text', wartość = dotknij pola i wybierz niebieski chip 'Szczegół powiadomienia' z kroku powyżej."},
  "ob.wallet_s6_title":      { en: "Get your URL & token from Budger", pl: "Pobierz URL i token z Budger"      },
  "ob.wallet_s6_desc":       { en: "Go to Budger → Alerts page → 'Apple Pay Setup'. Tap 'Copy URL' and 'Copy token' to copy each into the Shortcut steps above. Use the Test field on that page to send a sample notification text and confirm transactions appear automatically.",
                                pl: "Przejdź do Budger → Powiadomienia → 'Konfiguracja Apple Pay'. Dotknij 'Kopiuj URL' i 'Kopiuj token', aby skopiować każde do powyższych kroków Skrótu. Użyj pola Testuj na tej stronie, aby wysłać przykładowy tekst i potwierdzić, że transakcje pojawiają się automatycznie."},
  "ob.prev":                 { en: "Previous",                        pl: "Poprzedni"                         },
  "ob.next":                 { en: "Next",                            pl: "Następny"                          },
  // Wallet token page
  "wallet.setup_title":      { en: "Apple Pay Setup",                 pl: "Konfiguracja Apple Pay"            },
  "wallet.setup_desc":       { en: "Use this webhook URL and token in your iOS Shortcut to auto-import Apple Pay transactions.",
                                pl: "Użyj tego URL i tokenu w Skrócie iOS, aby automatycznie importować transakcje Apple Pay."},
  "wallet.your_url":         { en: "Webhook URL",                     pl: "URL webhooka"                      },
  "wallet.your_token":       { en: "Your token",                      pl: "Twój token"                        },
  "wallet.copy_url":         { en: "Copy URL",                        pl: "Kopiuj URL"                        },
  "wallet.copy_token":       { en: "Copy token",                      pl: "Kopiuj token"                      },
  "wallet.copied":           { en: "Copied!",                         pl: "Skopiowano!"                       },
  "wallet.regen":            { en: "Regenerate token",                pl: "Wygeneruj nowy token"              },
  "wallet.regen_warn":       { en: "This invalidates your current Shortcut. You'll need to update it with the new token.",
                                pl: "To unieważni Twój obecny Skrót. Musisz zaktualizować go nowym tokenem."},
  "wallet.loading":          { en: "Loading…",                        pl: "Ładowanie…"                        },
  "wallet.test_title":       { en: "Test the connection",             pl: "Przetestuj połączenie"             },
  "wallet.test_desc":        { en: "Send a sample notification text to verify your setup is working.",
                                pl: "Wyślij przykładowy tekst powiadomienia, aby sprawdzić czy konfiguracja działa."},
  "wallet.test_placeholder": { en: "e.g. Spent £15.50 at Starbucks", pl: "np. Zapłacono 15,50 zł w Starbucks"},
  "wallet.test_btn":         { en: "Test",                            pl: "Testuj"                            },
  "wallet.test_ok":          { en: "✓ Transaction created: {desc} {amount}",
                                pl: "✓ Transakcja utworzona: {desc} {amount}"                                 },
  "wallet.test_fail":        { en: "Could not parse — try a format like 'Spent £15.50 at Merchant'",
                                pl: "Nie udało się przetworzyć — spróbuj formatu 'Zapłacono 15,50 zł w Merchant'"},
  // Notifications step
