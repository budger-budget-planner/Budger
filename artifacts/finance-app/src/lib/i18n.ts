...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "ob.wallet_s1_desc":       { en: "After each Apple Pay purchase, your iPhone's Wallet sends a notification. An iOS Shortcut catches it and sends the details to Budger — automatically.",
                                pl: "Po każdej płatności Apple Pay Wallet wysyła powiadomienie. Skrót iOS przechwytuje je i wysyła dane do Budger — automatycznie."},
  "ob.wallet_s2_title":      { en: "Open Shortcuts app",              pl: "Otwórz aplikację Skróty"           },
  "ob.wallet_s2_desc":       { en: "On your iPhone, open the Shortcuts app. Tap the Automation tab at the bottom, then tap the + button in the top right to create a new automation.",
                                pl: "Na iPhonie otwórz aplikację Skróty. Dotknij zakładki Automatyzacja na dole, a następnie + w prawym górnym rogu, aby utworzyć nową automatyzację."},
  "ob.wallet_s3_title":      { en: "Choose Wallet as trigger",        pl: "Wybierz Wallet jako wyzwalacz"     },
  "ob.wallet_s3_desc":       { en: "Tap 'App' under trigger options. Search for 'Wallet', select it, then choose 'When notification is received'. Turn off 'Ask before running'.",
                                pl: "Dotknij 'Aplikacja' jako typ wyzwalacza. Wyszukaj 'Wallet', wybierz i zaznacz 'Gdy nadejdzie powiadomienie'. Wyłącz 'Pytaj przed uruchomieniem'."},
  "ob.wallet_s4_title":      { en: "Add 'Get Details' action",        pl: "Dodaj akcję 'Pobierz szczegóły'"   },
  "ob.wallet_s4_desc":       { en: "Tap 'Add action' and search for 'Get Details of Notification'. Select it — this extracts the notification text (e.g. 'Spent £15.50 at Costa').",
                                pl: "Dotknij 'Dodaj akcję' i wyszukaj 'Pobierz szczegóły powiadomienia'. Wybierz ją — wyodrębnia tekst powiadomienia (np. 'Zapłacono 15,50 zł w Costa')."},
  "ob.wallet_s5_title":      { en: "Add 'Get Contents of URL' action", pl: "Dodaj akcję 'Pobierz zawartość URL'"},
  "ob.wallet_s5_desc":       { en: "Add a 'Get Contents of URL' action. Set Method to POST, paste your Budger webhook URL, and add two JSON body fields: 'token' (your secret key from the Notifications page) and 'text' (drag in the 'Notification Detail' variable from the step above — this is the raw notification text like 'Spent £15.50 at Costa').",
                                pl: "Dodaj akcję 'Pobierz zawartość URL'. Ustaw metodę POST, wklej URL webhooka Budger i dodaj dwa pola JSON: 'token' (Twój tajny klucz ze strony Powiadomień) oraz 'text' (przeciągnij zmienną 'Szczegół powiadomienia' z kroku powyżej — to surowy tekst powiadomienia, np. 'Zapłacono 15,50 zł w Żabka')."},
  "ob.wallet_s6_title":      { en: "Copy your webhook URL",           pl: "Skopiuj swój URL webhooka"         },
  "ob.wallet_s6_desc":       { en: "In Budger, go to the Notifications page and tap 'Apple Pay Setup' to copy your personal webhook URL and token. Paste them into the Shortcut — you're all set!",
                                pl: "W Budger przejdź do strony Powiadomienia i dotknij 'Konfiguracja Apple Pay', aby skopiować swój URL webhooka i token. Wklej je do Skrótu — gotowe!"},
