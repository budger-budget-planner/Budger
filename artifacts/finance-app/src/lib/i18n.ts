...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "ob.wallet_s3_title":      { en: "Select Wallet → Sends a Notification", pl: "Wybierz Wallet → Wysyła powiadomienie"},
  "ob.wallet_s3_desc":       { en: "Type 'Wallet' in the app search and select it. Under 'When', choose 'Sends a Notification' — NOT 'Opens'. Tap Next. On the next screen set 'Run Immediately' ON and 'Notify When Run' OFF, then tap Done.",
                                pl: "Wpisz 'Wallet' w wyszukiwarce aplikacji i wybierz. Pod 'Kiedy' wybierz 'Wysyła powiadomienie' — NIE 'Otwiera'. Dotknij Dalej. Na kolejnym ekranie ustaw 'Uruchom natychmiast' na WŁ i 'Powiadamiaj po uruchomieniu' na WYŁ, następnie dotknij Gotowe."},
