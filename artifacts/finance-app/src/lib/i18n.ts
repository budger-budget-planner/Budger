...
const translations: Record<string, Record<Lang, string>> = {
 ...
 "larder.hint_reset":       { en: "Press to hide and reset",         pl: "Przytrzymaj by wyzerować"           },
  ...
  "larder.available_in_card": { en: "Available in this card",         pl: "Dostępne na tej karcie"            },
  ...
  "larder.head_assigns_hint": { en: "The Head assigns these funds",    pl: "Głowa domu przypisuje te środki"  },
