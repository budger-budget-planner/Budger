...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "home.add_photo":           { en: "Add photo",                         pl: "Dodaj zdjęcie"                   },
  "home.replace_photo":       { en: "Replace photo",                     pl: "Zmień zdjęcie"                   },
  ...
  "hh.your_role_parent_desc":   { en: "Can propose household goals. Head can always see your dashboard. You may request to become Head.",
                                   pl: "Może proponować cele. Głowa Rodziny zawsze widzi Twój pulpit. Możesz poprosić o rolę Głowy." },
  ...
  "hh.request_head_btn":        { en: "Request to become Head",   pl: "Poproś o rolę Głowy"                    },
