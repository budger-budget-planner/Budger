...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "ob.wallet_s2_desc":       { en: "Open the Shortcuts app. Tap the Automation tab at the bottom. Tap + in the top right. You'll see a list of trigger types — tap 'App' (not Wallet directly — that's the NFC card tap, which won't work here).",
                                pl: "Otwórz aplikację Skróty. Dotknij zakładki Automatyzacja. Dotknij + w prawym górnym rogu. Zobaczysz listę typów wyzwalaczy — dotknij 'Aplikacja' (nie 'Wallet' bezpośrednio — to wyzwalacz NFC, który tu nie zadziała)."},
  "ob.wallet_s3_title":      { en: "Select Wallet → Is Opened",       pl: "Wybierz Wallet → Jest otwierana"   },
  "ob.wallet_s3_desc":       { en: "Type 'Wallet' in the app search and select it. Choose 'Is Opened'. Tap Next. On the next screen turn 'Run Immediately' ON and 'Notify When Run' OFF, then tap Done. The shortcut fires when you tap the Wallet payment notification — which is when you have the transaction text.",
                                pl: "Wpisz 'Wallet' w wyszukiwarce aplikacji i wybierz. Wybierz 'Jest otwierana'. Dotknij Dalej. Na kolejnym ekranie ustaw 'Uruchom natychmiast' na WŁ i 'Powiadamiaj po uruchomieniu' na WYŁ. Skrót odpala się gdy dotkniesz powiadomienia Wallet o płatności — wtedy dostępny jest tekst transakcji."},
  "ob.wallet_s4_title":      { en: "Add 'Get Details of Notification'", pl: "Dodaj 'Pobierz szczegóły powiadomienia'"},
  "ob.wallet_s4_desc":       { en: "On the actions screen, tap the search bar and type 'Get Details of Notification'. Add it. It will show 'Get Body of Notification' — leave it as Body. This gives you the transaction text from the Wallet notification.",
                                pl: "Na ekranie akcji dotknij pola wyszukiwania i wpisz 'Pobierz szczegóły powiadomienia'. Dodaj ją. Pokaże 'Pobierz Treść powiadomienia' — zostaw jako Treść. To daje Ci tekst transakcji z powiadomienia Wallet."},
  "ob.wallet_s5_title":      { en: "Add 'Get Contents of URL'",       pl: "Dodaj 'Pobierz zawartość URL'"     },
  "ob.wallet_s5_desc":       { en: "Search for 'Get Contents of URL' and add it. Set Method to POST. Paste your Budger webhook URL. Tap 'Add new field' → JSON. Add field named 'token' with your token pasted as text. Add field named 'text', tap its value, and pick the 'Notification Detail' variable (blue chip) from the previous step.",
                                pl: "Wyszukaj 'Pobierz zawartość URL' i dodaj. Ustaw metodę POST. Wklej URL webhooka Budger. Dotknij 'Dodaj nowe pole' → JSON. Dodaj pole 'token' z wklejonym tokenem jako tekst. Dodaj pole 'text', dotknij jego wartości i wybierz zmienną 'Szczegół powiadomienia' (niebieski chip) z poprzedniego kroku."},
  "ob.wallet_s6_title":      { en: "Get your URL & token",            pl: "Skopiuj swój URL i token"          },
  "ob.wallet_s6_desc":       { en: "In Budger, go to the Alerts page and tap 'Apple Pay Setup'. Copy your webhook URL and token — you'll paste these into the Shortcut in the previous steps. You can also send a test notification from here to confirm everything works.",
                                pl: "W Budger przejdź do strony Powiadomienia i dotknij 'Konfiguracja Apple Pay'. Skopiuj URL webhooka i token — wklejasz je do Skrótu w poprzednich krokach. Możesz też wysłać testowe powiadomienie stąd, aby sprawdzić, czy wszystko działa."},
