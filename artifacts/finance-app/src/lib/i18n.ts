...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "ob.wallet_s1_desc":       { en: "When you pay with Apple Pay, your bank app (Monzo, Revolut, Barclays, etc.) sends a notification like 'Spent £15.50 at Costa'. An iOS Shortcut catches that text and sends it to Budger — no manual entry needed.",
                                pl: "Gdy płacisz Apple Pay, aplikacja bankowa (Monzo, Revolut, mBank itp.) wysyła powiadomienie jak 'Zapłacono 15,50 zł w Costa'. Skrót iOS przechwytuje ten tekst i wysyła go do Budger — bez ręcznego wpisywania."},
  "ob.wallet_s2_title":      { en: "Automation → + → App",            pl: "Automatyzacja → + → Aplikacja"    },
  "ob.wallet_s2_desc":       { en: "Open Shortcuts → Automation tab → tap +. Choose 'App' from the trigger list. Do NOT pick Wallet — that is the NFC tap trigger and has no notification text. You want the app that sends you 'you just paid' push notifications — usually your bank app.",
                                pl: "Otwórz Skróty → Automatyzacja → dotknij +. Wybierz 'Aplikacja' z listy wyzwalaczy. NIE wybieraj Wallet — to wyzwalacz NFC bez tekstu powiadomień. Chodzi o aplikację, która wysyła Ci powiadomienia o płatnościach — zazwyczaj aplikacja bankowa."},
  "ob.wallet_s3_title":      { en: "Pick your bank app → Sends a Notification", pl: "Wybierz aplikację bankową → Wysyła powiadomienie"},
  "ob.wallet_s3_desc":       { en: "Search for your bank app (e.g. Monzo, Revolut, Barclays). Select it and choose 'Sends a Notification'. Tap Next. Turn 'Run Immediately' ON and 'Notify When Run' OFF. Tap Done. The shortcut will fire every time your bank notifies you of a payment.",
                                pl: "Wyszukaj swoją aplikację bankową (np. Revolut, mBank, PKO). Wybierz ją i zaznacz 'Wysyła powiadomienie'. Dalej. Ustaw 'Uruchom natychmiast' WŁ i 'Powiadamiaj po uruchomieniu' WYŁ. Gotowe. Skrót odpali się za każdym razem gdy bank powiadomi o płatności."},
  "ob.wallet_s4_title":      { en: "Search: 'Get Details of Notification'", pl: "Szukaj: 'Pobierz szczegóły powiadomienia'"},
  "ob.wallet_s4_desc":       { en: "In the action editor tap the Search bar at the bottom. Type 'Get Details of Notification' and add it. Make sure it says 'Body' (not Title). This captures the payment text from your bank notification — the key step that unlocks the other actions.",
                                pl: "W edytorze akcji dotknij paska wyszukiwania na dole. Wpisz 'Pobierz szczegóły powiadomienia' i dodaj. Upewnij się, że wyświetla 'Treść' (nie Tytuł). To przechwytuje tekst płatności z powiadomienia bankowego."},
  "ob.wallet_s5_title":      { en: "Search: 'Get Contents of URL'",   pl: "Szukaj: 'Pobierz zawartość URL'"  },
  "ob.wallet_s5_desc":       { en: "Search for 'Get Contents of URL' and add it. Set Method to POST, paste your Budger webhook URL. Tap 'Add new field' → JSON. Add field 'token' with your token as plain text. Add field 'text', tap its value, then pick the 'Notification Detail' blue chip from the previous step — do not type it manually.",
                                pl: "Wyszukaj 'Pobierz zawartość URL' i dodaj. Metoda POST, wklej URL webhooka Budger. 'Dodaj nowe pole' → JSON. Pole 'token' = Twój token jako tekst. Pole 'text' = dotknij wartości i wybierz niebieski chip 'Szczegół powiadomienia' z poprzedniego kroku — nie wpisuj ręcznie."},
  "ob.wallet_s6_title":      { en: "Copy your URL & token from Budger", pl: "Skopiuj URL i token z Budger"    },
  "ob.wallet_s6_desc":       { en: "Go to Budger → Alerts → 'Apple Pay Setup'. Copy your webhook URL and token — paste them into the Shortcut above. You can test without spending money: paste any bank notification text (e.g. 'Spent £5.00 at Tesco') into the Test field and tap Test.",
                                pl: "Przejdź do Budger → Powiadomienia → 'Konfiguracja Apple Pay'. Skopiuj URL webhooka i token — wklej do Skrótu. Możesz przetestować bez wydawania pieniędzy: wklej tekst powiadomienia (np. 'Zapłacono 5,00 zł w Biedronka') w pole Testuj i dotknij Testuj."},
