...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "ob.wallet_s4_title":      { en: "Search for 'Get Details of Notification'", pl: "Wyszukaj 'Pobierz szczegóły powiadomienia'"},
  "ob.wallet_s4_desc":       { en: "You should now be in the shortcut editor. Look for a search bar or a + button to add a step. Search 'Get Details of Notification' and add it. It extracts the payment text (e.g. 'Spent £15.50 at Costa') from the Wallet notification that opened the app.",
                                pl: "Teraz jesteś w edytorze skrótu. Znajdź pasek wyszukiwania lub przycisk + aby dodać krok. Wyszukaj 'Pobierz szczegóły powiadomienia' i dodaj. Wyodrębnia tekst płatności z powiadomienia Wallet, które otworzyło aplikację."},
  "ob.wallet_s5_title":      { en: "Search for 'Get Contents of URL'", pl: "Wyszukaj 'Pobierz zawartość URL'" },
  "ob.wallet_s5_desc":       { en: "Add another step: search 'Get Contents of URL'. Set Method POST, paste your Budger webhook URL. Add two JSON body fields: 'token' → paste your token as plain text; 'text' → tap the value field and insert the 'Notification Detail' variable from the previous step (appears as a blue pill/chip).",
                                pl: "Dodaj kolejny krok: wyszukaj 'Pobierz zawartość URL'. Metoda POST, wklej URL webhooka Budger. Dodaj dwa pola JSON: 'token' → wklej swój token jako tekst; 'text' → dotknij pola wartości i wstaw zmienną 'Szczegół powiadomienia' z poprzedniego kroku (pojawi się jako niebieski chip)."},
