...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "login.pending_deletion":     { en: "Account scheduled for deletion",
                                   pl: "Konto zaplanowane do usunięcia" },
  "login.pending_deletion_sub": { en: "Your account will be permanently deleted within 24 hours. You cannot log in or sign up with this email during that time.",
                                   pl: "Twoje konto zostanie trwale usunięte w ciągu 24 godzin. W tym czasie nie możesz się zalogować ani zarejestrować na ten adres e-mail." },
  "login.account_pending_deletion": { en: "This account is scheduled for deletion. Sign-in is not available during the 24-hour grace period.",
                                       pl: "To konto jest zaplanowane do usunięcia. Logowanie jest niedostępne przez 24-godzinny okres oczekiwania." },
